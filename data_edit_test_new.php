<! doctype html>
<!-- data_edit_test_new.php
     Data Edit page of the 'Pirro Nord: a WebGIS approach' project | PiNo -->

<html lang="en">
<head>
  <link rel="stylesheet" type="text/css" href="data_edit.css">
  <title>Pirro Nord: a WebGIS approach | Data Edit</title>
  <meta charset="utf-8">
...
<body>
  ...
  <section>
    ...
    <form id="view" enctype="text/plain" action="data_edit_test_new.php" method="GET">
      <input type="hidden" name="redirect" value="data_edit_test_new.php"/>
      <ul>
	<fieldset>
...
echo "<p>Now you can update information regarding the record:</p>
  <form id='edit' enctype='text/plain' action='data_edit_test_new.php' method='REQUEST'>
<p><em>$_GET[code]</em></p>
